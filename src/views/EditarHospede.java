...
public class EditarHospede extends JFrame {
	...
	public EditarHospede(Hospede registroHospede) {
		super("Editar Hóspede");
		...
		campoSobrenome.setText(registroHospede.getSobrenome());
		...
		campoTelefone.setText(registroHospede.getTelefone());
		...
		numeroReserva.setText(registroHospede.getIdReserva());
